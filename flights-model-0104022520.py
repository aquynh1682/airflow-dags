...
args = {
    "project_id": "flights-model-0104022520",
}

dag = DAG(
    "flights-model-0104022520",
    default_args=args,
...
notebook_op_4b76ee22_35c2_4e98_b980_0fe294a10f98 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="flights-model-0104022520",
...
notebook_op_a8a2be4d_dfd1_4a0a_9ce5_5477d6bf8b56 = NotebookOp(
    ...
    env_vars={
        ...
        "MODEL_NAME": "flights-ontime",
        "MODEL_VERSION": "1",
        "CONTAINER_DETAILS": "docker.io/quynhngo113/container-model:2.0.1",

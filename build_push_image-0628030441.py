...
args = {
    "project_id": "build_push_image-0628030441",
}

dag = DAG(
    "build_push_image-0628030441",
    default_args=args,
...
notebook_op_551e3953_88a6_491c_bf47_8592a82ed89d = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="build_push_image-0628030441",
    cos_dependencies_archive="build_push_image-551e3953-88a6-491c-bf47-8592a82ed89d.tar.gz",
    pipeline_outputs=[],
    pipeline_inputs=[],
...
notebook_op_551e3953_88a6_491c_bf47_8592a82ed89d.image_pull_policy = "Never"

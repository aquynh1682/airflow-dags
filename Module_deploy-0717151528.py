...
args = {
    "project_id": "Module_deploy-0717151528",
}

dag = DAG(
    "Module_deploy-0717151528",
    default_args=args,
...
notebook_op_1a62dbb5_1c89_49a0_a8e5_6e88e85aca77 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="Module_deploy-0717151528",
    ...
    env_vars={
        ...
        "MODEL_VERSION": "1",
        "CONTAINER_REGISTRY": "https://index.docker.io/v2",
        "CONTAINER_REGISTRY_USER": "quynhngo113",
        "CONTAINER_REGISTRY_PASSWORD": "Quynhlp123456a@",
        "CONTAINER_DETAILS": "quynhngo113/hellomlflow:latest",
    },
    config_file="None",
    dag=dag,
)

...
args = {
    "project_id": "Module_deploy-0717104414",
}

dag = DAG(
    "Module_deploy-0717104414",
    default_args=args,
...
notebook_op_1a62dbb5_1c89_49a0_a8e5_6e88e85aca77 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="Module_deploy-0717104414",
    ...
    env_vars={
        ...
        "CONTAINER_DETAILS": "quynhngo113/hellomlflow-manual:latest",
    },
    config_file="None",
    dag=dag,
)

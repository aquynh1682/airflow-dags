...
args = {
    "project_id": "model_deploy-0630030837",
}

dag = DAG(
    "model_deploy-0630030837",
    default_args=args,
...
notebook_op_9656b70b_b273_4c0b_9cea_8fa84bfd5909 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="model_deploy-0630030837",
    ...
    env_vars={
        ...
        "MODEL_VERSION": "1",
        "CONTAINER_REGISTRY": "https://hub.docker.com/v2/",
        "CONTAINER_REGISTRY_USER": "quynhngo113",
        "CONTAINER_REGISTRY_PASSWORD": "Quynhlp123456a@",
        "CONTAINER_DETAILS": "quynhngo113/mlflowdemo:la",
    },
    config_file="None",
    dag=dag,
)
...
notebook_op_31574f1c_4274_40f5_8a4a_bcabd311f6e9 = NotebookOp(
    ...
    env_vars={
        ...
        "MODEL_NAME": "mlflowdemo",
        "MODEL_VERSION": "1",
        "CONTAINER_DETAILS": "quynhngo113/mlflowdemo:tagname:latest",
    },
    config_file="None",
    dag=dag,
)

...
args = {
    "project_id": "build_push_image-0628030023",
}

dag = DAG(
    "build_push_image-0628030023",
    default_args=args,
...
notebook_op_842ae114_12a6_415f_8b39_14f5f4cbd6bc = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="build_push_image-0628030023",
    cos_dependencies_archive="build_push_image-842ae114-12a6-415f-8b39-14f5f4cbd6bc.tar.gz",
    pipeline_outputs=[],
    pipeline_inputs=[],
...
notebook_op_842ae114_12a6_415f_8b39_14f5f4cbd6bc.image_pull_policy = "Never"

...
args = {
    "project_id": "flights-model-0104095901",
}

dag = DAG(
    "flights-model-0104095901",
    default_args=args,
...
notebook_op_4b76ee22_35c2_4e98_b980_0fe294a10f98 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="flights-model-0104095901",
    ...
    env_vars={
        ...
        "CONTAINER_DETAILS": "quynhngo113/container-model:2.0.1",
    },
    config_file="None",
    dag=dag,
)
...
notebook_op_a8a2be4d_dfd1_4a0a_9ce5_5477d6bf8b56 = NotebookOp(
    ...
    env_vars={
        ...
        "MODEL_NAME": "flights-ontime",
        "MODEL_VERSION": "1",
        "CONTAINER_DETAILS": "docker.io/quynhngo113/container-model:v1.0.0",
        "CLUSTER_DOMAIN_NAME": "chap10.vdigital-cloud.vn",
    },
    config_file="None",
    dag=dag,
)

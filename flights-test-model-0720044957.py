...
args = {
    "project_id": "flights-test-model-0720044957",
}

dag = DAG(
    "flights-test-model-0720044957",
    default_args=args,
    schedule_interval="@once",
    start_date=days_ago(1),
    description="Created with Elyra 2.2.4 pipeline editor using flights-test-model.pipeline.",
...
notebook_op_4b76ee22_35c2_4e98_b980_0fe294a10f98 = NotebookOp(
    ...
    cos_bucket="airflow",
    cos_directory="flights-test-model-0720044957",
    ...
    env_vars={
        ...
        "CONTAINER_DETAILS": "quynhngo113/container-model:1.0.4",
    },
    config_file="None",
    dag=dag,
)
...
notebook_op_a8a2be4d_dfd1_4a0a_9ce5_5477d6bf8b56 = NotebookOp(
    ...
    env_vars={
        ...
        "MODEL_NAME": "flights-ontime",
        "MODEL_VERSION": "1",
        "CLUSTER_DOMAIN_NAME": "quynhngo.xyz",
        "CONTAINER_DETAILS": "quynhngo113/container-model:1.0.4",
    },
    config_file="None",
    dag=dag,
